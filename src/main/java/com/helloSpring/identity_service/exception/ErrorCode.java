...
public enum ErrorCode {
    ...
    PASSWORD_ERROR(1002, "Password error", HttpStatus.BAD_REQUEST),
    USERNAME_INVALID(1003, "User name invalid", HttpStatus.BAD_REQUEST),
    USERNAME_ERROR(1004, "User name is must be 8 charater", HttpStatus.BAD_REQUEST),
    USER_NOT_EXISTED(1005, "User not existed", HttpStatus.NOT_FOUND),
    UNAUTHENTICATED(1006, "Unauthenticated", HttpStatus.UNAUTHORIZED),
    UNAUTHORIZED(1007, "You not have permission", HttpStatus.FORBIDDEN),
    INVALID_DOB(1008, "Invalid day of birth", HttpStatus.BAD_REQUEST),
